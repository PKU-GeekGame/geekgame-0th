...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'mid.wast';
  var wasmBinaryFile = 'mid.wasm';
  var asmjsCodeFile = 'mid.temp.asm.js';
...
// {{PRE_LIBRARY}}
  ...
  function _n() {
  err('missing function: n'); abort(-1);
  }

  function _rightans() {
  err('missing function: rightans'); abort(-1);
  }

  function _rightn() {
  err('missing function: rightn'); abort(-1);
  }

  function _s() {
  err('missing function: s'); abort(-1);
  }
